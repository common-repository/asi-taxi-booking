            ...
            for (var i = 0; i < origins.length; i++) {
                ...
                for (var j = 0; j < results.length; j++) {
                   ...
                   estimated_fare = curr + estimated_fare.toFixed(2);
                    ...
                    if (r == true)
                    {                        
                        alert('An Email has been sent to Admin and on your email address!');
                       return true;
                    } 
                    else 
                    {
...
function clear_form_elements(ele) {
    ...
    document.getElementById("baby_seat").value = 0;
    document.getElementById("stops_div").value = "";
    document.getElementById("stops_count").value = 0;
}
jQuery(document).on('click','.rembook',function(){
 ...
 jQuery.post(base_url+'/wp-admin/admin-ajax.php', {action: 'asi_deletebooking', id:id},function(){
